...
local customfont = Drawing.new("Font", "smallestpixel")
...
local library = {
    ...
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/razorwarecc/core-drawing/main/signal3'))();
    open = false;
    opening = false;
    hasInit = false;
...
function library:init()
    ...
    function self:SaveConfig(name, mode)
...
function library:CreateSettingsTab(menu)
    ...
    configSection:AddButton({text = 'Load', confirm = true, callback = function()
        ...
        library:SaveConfig(library.flags.selectedconfig, "overwrite");
    end})
    ...
    configSection:AddButton({text = 'Create', confirm = true, callback = function()
        ...
        library:SaveConfig(library.flags.selectedconfig, "create")
        refreshConfigs()
    ...
    mainSection:AddButton({text = 'Copy Discord', flag = 'copydiscord', callback = function()
        setclipboard('discord.gg/mj4n6fE8zS')
    end})

    mainSection:AddButton({text = 'Join Lowest Server', confirm = true, callback = function()
